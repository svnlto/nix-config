return {
  -- GitHub integration with octo.nvim
  {
    ...
    keys = {
      -- GitHub workflow keymaps - using available letters that don't conflict
      ...
      -- Use 'o' for octo (GitHub) submenu
      { "<leader>go", "<cmd>Octo<cr>", desc = "🐙 GitHub (Octo)" },
    },
    opts = {
      use_local_fs = false, -- use files in git repository
      enable_builtin = true, -- shows a list of builtin actions when no action is provided
      default_remote = { "upstream", "origin" }, -- order of preference for remotes
      default_merge_method = "commit", -- default merge method which should be used with `Octo pr merge`, could be `commit`, `rebase` or `squash`
      ...
      ui = {
        ...
        use_signstatus = true, -- show issue/PR status in the sign column
      },
      issues = {
      ...
      mappings_disable_default = false, -- disable default mappings
      mappings = {
        issue = {
